        ...
        <section>
            <div id="sec-1" class="row d-flex p-5 min-500 bg-white relative stagger-down">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12">
                    ...
                    <a href="/about.php" class="animate-link"><p class="p-btn mt-3 slide-down">Discover <i class="fa fa-angle-right fa-btn orange"></i></p></a>  
                </div>
            </div><!--end row-->
        </section>
        ...
        <section>
            <div class="row d-flex p-5 min-500 bg-white stagger-right">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12">
                    ...
                    <a href="/jaxxliberty.php" class="animate-link"><p class="p-btn mt-3 slide-right">Find out more <i class="fa fa-angle-right fa-btn orange"></i></p></a>  
                </div>
            </div><!--end row-->
        </section>
        ...
        <section>
            <div class="row d-flex p-5 min-500 bg-white stagger-down">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 left">
                    ...
                    <a href="/partner-network.php" class="animate-link"><p class="p-btn mt-3 slide-down">Connect with us <i class="fa fa-angle-right fa-btn orange"></i></p></a> 
                </div>
            </div><!--end row-->
        </section>
