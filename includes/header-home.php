...
<html class="no-js" lang="">
  ...
  <body>
    <div class="m-scene" id="main">
       ...
       <!--nav-->
        <nav id="home" class="navbar fixed-top navbar-expand-lg scene_element scene_element--fadeindown">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/about.php">About Decentral</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/jaxxliberty.php">Jaxx Liberty</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/home3.php">Partnerships</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/features.php">Team</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://decentral.jaxx.io/" target="_blank">Blog</a>
                    </li>
                    <li class="nav-item">
