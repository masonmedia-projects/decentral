...
<main id="main">
    <div class="container-fluid p-0 text-secondary">
            ...
            <div id="sec-1" class="row d-flex p-5 min-500 bg-white relative stagger-down">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 down down-med">
                    ...
                    <div class="down down-slow">
                        <a href="/about"><p class="p-btn mt-3 slide-down">Discover <i class="fa fa-angle-right fa-btn orange"></i></p></a>  
                    </div>
                </div>
            </div><!--end row-->
        </section>
            ...
            <div class="row d-flex p-5 min-500 bg-white stagger-right">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 right right-med">
                    ...
                    <div class="right right-slow">
                        <a href="/jaxxliberty"><p class="p-btn mt-3 slide-right">Find out more <i class="fa fa-angle-right fa-btn orange"></i></p></a>  
                    </div>
                </div>
            </div><!--end row-->
        </section>
        ...
        <section>
            <div class="row d-flex p-5 min-500 bg-white stagger-down">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 down down-med">
                    ...
                    <div class="down down-slow">
                        <a href="/partner-network"><p class="p-btn mt-3 slide-down">Connect with us <i class="fa fa-angle-right fa-btn orange"></i></p></a> 
                    </div>
                </div>
            </div><!--end row-->
        </section>
        ...
        <section>
            <div class="row d-flex bg-light">
                <div class="col-lg-12 min-700-lg down down-med">
                    <img class="img-full absolute z-0 left-0 lazy" data-src="/assets/img/jaxx-girl-laptop-phone.jpg" alt="We champion the decentralized movement by building technology that empowers." title="Decentral team">
                </div>
            </div>
        </section>
